...
urlpatterns = [
    ...
    path('update-registration/<str:id>', views.updateRegistration, name='update-registration'),
    path('delete-registration/<str:id>', views.deleteRegistration, name='delete-registration'),
]